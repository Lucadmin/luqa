...
class UpdateGroupRequest {
  ...
  @override
  String toString() =>
      'UpdateGroupRequest[name=$name, color=$color, emoji=$emoji, memberIds=$memberIds, order=$order, archived=$archived]';
  ...
  /// Clones this instance of [UpdateGroupRequest] and returns a new one where some of the
  ...
  static List<UpdateGroupRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UpdateGroupRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UpdateGroupRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
