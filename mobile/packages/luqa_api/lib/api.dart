...
part 'model/create_habit_request.dart';
part 'model/create_person_gift_request.dart';
part 'model/create_person_note_request.dart';
part 'model/create_person_place_request.dart';
...
part 'model/delete_gym_exercise_response.dart';
...
part 'model/gym_session_delta.dart';
...
part 'model/habit.dart';
part 'model/habit_delta.dart';
part 'model/habit_goal_period.dart';
part 'model/habit_goal_type.dart';
part 'model/habit_list_response.dart';
part 'model/habit_log.dart';
part 'model/habit_log_delta.dart';
part 'model/habit_log_response.dart';
part 'model/habit_response.dart';
part 'model/habit_schedule_type.dart';
...
part 'model/mark_seen_request.dart';
part 'model/merge_gym_exercise_request.dart';
...
part 'model/sleep_entry_delta.dart';
...
part 'model/sync_collections.dart';
part 'model/sync_exercise.dart';
part 'model/sync_response.dart';
part 'model/sync_settings.dart';
part 'model/time_entry.dart';
part 'model/time_entry_delta.dart';
...
part 'model/update_gym_exercise_request.dart';
part 'model/update_gym_location_request.dart';
part 'model/update_gym_session_request.dart';
part 'model/update_habit_request.dart';
part 'model/update_person_gift_request.dart';
part 'model/update_person_note_request.dart';
